...
public class ControllersExceptions {
    ...
    @ExceptionHandler({CustomerExistException.class, CustomerNotExistException.class, PasswordIncorrectException.class, EmailValidationException.class, PurchaseNotExistException.class})
